...
#include "turbulentPipeMixingLengthDissipationRateInletFvPatchScalarField.H"
...
turbulentPipeMixingLengthDissipationRateInletFvPatchScalarField::
turbulentPipeMixingLengthDissipationRateInletFvPatchScalarField
(
    const fvPatch& p,
...
:
    inletOutletPipeFvPatchField(p, iF),
...
turbulentPipeMixingLengthDissipationRateInletFvPatchScalarField
(
    const turbulentPipeMixingLengthDissipationRateInletFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    const fieldMapper& mapper
)
:
    inletOutletPipeFvPatchField(ptf, p, iF, mapper),
...
:
    inletOutletPipeFvPatchField(ptf, iF),
    turbulentLengthScale_(ptf.turbulentLengthScale_),
    kName_(ptf.kName_),
    Cmu_(ptf.Cmu_)
{}
...
void turbulentPipeMixingLengthDissipationRateInletFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    this->refValue() = 
        Cmu75*kp*sqrt(kp)/(turbulentLengthScale_*this->hydraulicDiameter_);
...
void turbulentPipeMixingLengthDissipationRateInletFvPatchScalarField::write
(
    Ostream& os
) const
{
